VERSION 5.00
Begin VB.Form frm0212huaweiPrint 
   BackColor       =   &H00FFFFFF&
   ...
   Begin VB.PictureBox picH3C 
      ...
      Height          =   1935
      Left            =   120
      Picture         =   "frm0212huaweiPrint.frx":0000
      ScaleHeight     =   1905
      ScaleWidth      =   10425
      TabIndex        =   6
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frm0212huaweiPrint"
...
Private Sub OpenLppx()
   ...
   Set myDoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\逆向标签模板\" & "风扇0212二维码标签new.lab")
