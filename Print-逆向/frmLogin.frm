...
Private Sub Form_Load()
  ...
  conn.Open
    ...
    DisplayVerInfo
    'show the results
    frmLogin.Caption = "单板+3COMPrint(逆向) ( Version: " & FileVer & " )"
...
Private Sub check_ver()
    strSql = "select APP_Version from Version_Control with(NOLOCK) where APP_Name=N'单板+3COMPrint(逆向)' "
