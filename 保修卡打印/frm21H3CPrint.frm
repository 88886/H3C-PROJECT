VERSION 5.00
Begin VB.Form frmH3CPrintWarranty 
   BackColor       =   &H00FFFFFF&
   ...
   End
End
Attribute VB_Name = "frmH3CPrintWarranty"
...
Private Sub cmdPrint_Click()
  ...
  Dim res As New ADODB.Recordset
   ...
   End If
     ...
     sql = "select TYPE from SingleUnit where SN='" & partCut & "'"
     If rec.State = 1 Then
      rec.Close
       End If
...
Private Sub OpenLppx()
   ...
   Set myDoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\" & "产品资料.lab")
