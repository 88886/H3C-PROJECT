...
Private Sub Form_Load()
  ...
  conn.Open
    ...
    DisplayVerInfo
    'show the results
    frmLogin.Caption = "单板出货(逆向)HWF ( Version: " & FileVer & " )"
...
Private Sub check_ver()
    strSql = "select APP_Version from Version_Control with(NOLOCK) where APP_Name=N'单板出货(逆向)HWF' "
