  ...
  If txtPack.Text = "" Then
   ...
   If op = "Insert" Then
      ...
      If rcd.Fields(0) > 0 Then
         MsgBox "HP Serial Number-III已存在!"
         txtHPPN.SetFocus
         Exit Sub
      End If
      rcd.Close
      sql = "insert hp(row_number,h3c_bom_code,h3c_sn_iii,hp_pn,hp_product,hp_sn_iii,hp_desc1,hp_desc2,hp_gtin,hp_gtin_number,h3c_type,pack_label)" & _
            "Values('" & txtRN.Text & "','" & txtCode.Text & "','" & txtH3CSNIII.Text & "','" & txtHPPN.Text & "','" & txtHPP.Text & "','" & txtHPSNIII.Text & "'," & _
            "'" & txtHPdesc1.Text & "','" & txtHPdesc2.Text & "','" & txtHPGtin.Text & "','" & txtHPGtinNum.Text & "','" & txtH3CType.Text & "','" & txtPack.Text & "')"
   ...
   ElseIf op = "Update" Then
      sql = "Update hp set row_number='" & txtRN.Text & "',h3c_bom_code='" & txtCode.Text & "',h3c_sn_iii='" & txtH3CSNIII.Text & "',hp_product='" & txtHPP.Text & "'," & _
            "hp_pn='" & txtHPPN.Text & "', hp_desc1='" & txtHPdesc1.Text & "',hp_desc2='" & txtHPdesc2.Text & "',hp_gtin='" & txtHPGtin.Text & "',hp_gtin_number='" & txtHPGtinNum.Text & "',h3c_type='" & txtH3CType.Text & "',pack_label='" & txtPack.Text & "'" & _
            " where hp_sn_iii='" & txtHPSNIII.Text & "'"
     ' MsgBox (sql)
      status = Connect.excuteUpdate(sql)
      If status <> "" Then
            ...
            If K = 12 Then
               If action = vbRetry Then
                   sql = "Update hp set row_number='" & xlSheet.Cells(j, 1) & "',h3c_bom_code='" & xlSheet.Cells(j, 2) & "',h3c_sn_iii='" & xlSheet.Cells(j, 3) & "',hp_product='" & xlSheet.Cells(j, 5) & "'," & _
                        "hp_pn='" & xlSheet.Cells(j, 4) & "',hp_desc1='" & xlSheet.Cells(j, 7) & "',hp_desc2='" & xlSheet.Cells(j, 8) & "',hp_gtin='" & xlSheet.Cells(j, 9) & "',hp_gtin_number='" & xlSheet.Cells(j, 10) & "',h3c_type='" & xlSheet.Cells(j, 11) & "',pack_label='" & xlSheet.Cells(j, 12) & "'" & _
...
'                   MsgBox "修改HUAWEI设定资料成功!"
               ...
               'MsgBox (xlSheet.Cells(j, 11))
                   sql = "Insert into hp(row_number,h3c_bom_code,h3c_sn_iii,hp_pn,hp_product,hp_sn_iii,hp_desc1,hp_desc2,hp_gtin,hp_gtin_number,h3c_type,pack_label) Values('" & xlSheet.Cells(j, 1) & "','" & xlSheet.Cells(j, 2) & "','" & xlSheet.Cells(j, 3) & "','" & xlSheet.Cells(j, 4) & "','" & xlSheet.Cells(j, 5) & "','" & xlSheet.Cells(j, 6) & "','" & xlSheet.Cells(j, 7) & "','" & xlSheet.Cells(j, 8) & "','" & xlSheet.Cells(j, 9) & "','" & xlSheet.Cells(j, 10) & "','" & xlSheet.Cells(j, 11) & "','" & xlSheet.Cells(j, 12) & "')"
                  'MsgBox (sql)
                   status = Connect.excuteUpdate(sql)
                   If status <> "" Then
                      MsgBox "新增HP设定资料失败!" & "原因是" & status
