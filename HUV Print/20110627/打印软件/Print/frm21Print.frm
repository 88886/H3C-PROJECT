VERSION 5.00
Begin VB.Form frm21Print 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "非3COM整机模块类标签打印"
   ClientHeight    =   5220
   ClientLeft      =   45
   ClientTop       =   405
   ClientWidth     =   10665
...
Private Sub OpenLppx()
   ...
   Set myDoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\标签模板\" & "H3C21.lab")
