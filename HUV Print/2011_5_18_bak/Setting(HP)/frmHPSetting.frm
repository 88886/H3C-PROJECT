  ...
  If txtPack.Text = "" Then
   ...
   If op = "Insert" Then
      ...
      sql = "insert hp(row_number,h3c_bom_code,h3c_sn_iii,hp_pn,hp_product,hp_sn_iii,hp_desc1,hp_desc2,hp_gtin,hp_gtin_number,h3c_type,pack_label)" & _
            ...
            "'" & txtHPdesc1.Text & "','" & txtHPdesc2.Text & "','" & txtHPGtin.Text & "','" & Trim(txtHPGtinNum.Text) & "','" & txtH3CType.Text & "','" & txtPack.Text & "')"
   ...
   ElseIf op = "Update" Then
      sql = "Update hp set row_number='" & txtRN.Text & "',h3c_bom_code='" & txtCode.Text & "',h3c_sn_iii='" & txtH3CSNIII.Text & "',hp_product='" & txtHPP.Text & "'," & _
            "hp_pn='" & txtHPPN.Text & "', hp_desc1='" & txtHPdesc1.Text & "',hp_desc2='" & txtHPdesc2.Text & "',hp_gtin='" & txtHPGtin.Text & "',hp_gtin_number='" & Trim(txtHPGtinNum.Text) & "',h3c_type='" & txtH3CType.Text & "',pack_label='" & txtPack.Text & "'" & _
