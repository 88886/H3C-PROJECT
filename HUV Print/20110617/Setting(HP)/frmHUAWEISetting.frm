...
Private Sub cmdConfirm_Click()
   ...
   Dim CE, WEEE, ChinaRoHS, RoHS, SVPrint As String
   If chkCE.Value = 1 Then
      CE = "CE"
   ...
   If op = "Insert" Then
      ...
      sql = "Insert into tblHuaWei(ID, HV, SN, CPN, EPN, Des, OS, GW, CE, WEEE, ChinaRoHS, RoHS, MS, MSValidFrom, NAL, ValidFrom, PrintSV, Remark) " & _
            ...
            "'" & txtMS.Text & "','" & Me.dtpMSValidFrom.Value & "','" & txtNAL.Text & "','" & dtpValidFrom.Value & "','" & SVPrint & "','" & txtRemark.Text & "')"
   ...
   ElseIf op = "Update" Then
      sql = "Update tblHuaWei set HV='" & Trim(txtHV.Text) & "',CPN='" & Trim(txtCPN.Text) & "',EPN='" & Trim(txtEPN.Text) & "',Des='" & Trim(txtDes.Text) & "',OS='" & Trim(txtOS.Text) & "',GW='" & Trim(txtGW.Text) & "',CE='" & CE & "',WEEE='" & WEEE & "',chinarohs='" & ChinaRoHS & "',RoHS='" & RoHS & "'," & _
            "MS='" & txtMS.Text & "',MSValidFrom='" & Me.dtpMSValidFrom.Value & "',NAL='" & txtNAL.Text & "',ValidFrom='" & dtpValidFrom.Value & "',PrintSV='" & SVPrint & "',Remark='" & txtRemark.Text & "'" & _
...
Private Sub mfgHUAWEI_Click()
   If mfgHUAWEI.RowSel > 0 Then
      ...
      txtRemark.Text = mfgHUAWEI.TextMatrix(mfgHUAWEI.RowSel, 18)
   End If
End Sub
