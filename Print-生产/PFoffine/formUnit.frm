...
'     End If
 ...
 '    End If
  ...
  '   End If
    ...
    '***************************************************************************************add york by 20190128
    If (Me.tbPart.Text = "ASR6026PF" Or Me.tbPart.Text = "ASR6126PF" Or Me.tbPart.Text = "ASR6026PF-DC" Or Me.tbPart.Text = "ASR6126PF-DC" Or Me.tbPart.Text = "ASR6226PF-AC" Or Me.tbPart.Text = "ASR6326PF-AC") Then
    arr2(0, 1) = Right$("000" + dectohex(CStr(CDbl(HEXTODEC(tbMACFrom.Text)) + 0 * 32)), Len(Me.tbMACFrom.Text))    'mac进制和累加
    ElseIf (Me.tbPart.Text = "ASR7024PF-AC" Or Me.tbPart.Text = "ASR7024EPF-AC" Or Me.tbPart.Text = "ASR8024PF-AC" Or Me.tbPart.Text = "ASR8024EPF-AC") Then
    arr2(0, 1) = Right$("000" + dectohex(CStr(CDbl(HEXTODEC(tbMACFrom.Text)) + 0 * 28)), Len(Me.tbMACFrom.Text))
    ElseIf (Me.tbPart.Text = "ASR8048PF-AC" Or Me.tbPart.Text = "ASR8048EPF-AC" Or Me.tbPart.Text = "ASR7048PF-AC" Or Me.tbPart.Text = "ASR7048EPF-AC") Then
    arr2(0, 1) = Right$("000" + dectohex(CStr(CDbl(HEXTODEC(tbMACFrom.Text)) + 0 * 56)), Len(Me.tbMACFrom.Text))
    End If
    ...
    ElseIf (Me.tbPart.Text = "ASR7024PF-AC" Or Me.tbPart.Text = "ASR7024EPF-AC" Or Me.tbPart.Text = "ASR8024PF-AC" Or Me.tbPart.Text = "ASR8024EPF-AC") Then
    arr2(i, 1) = Right$("000" + dectohex(CStr(CDbl(HEXTODEC(arr2(i - 1, 1))) + 28)), Len(arr2(i - 1, 1)))
    ElseIf (Me.tbPart.Text = "ASR8048PF-AC" Or Me.tbPart.Text = "ASR8048EPF-AC" Or Me.tbPart.Text = "ASR7048PF-AC" Or Me.tbPart.Text = "ASR7048EPF-AC") Then
    arr2(i, 1) = Right$("000" + dectohex(CStr(CDbl(HEXTODEC(arr2(i - 1, 1))) + 56)), Len(arr2(i - 1, 1)))
    End If
     '   arr2(i, 1) = Right$("000" + dectohex(CStr(CDbl(HEXTODEC(arr2(i - 1, 1))) + 32)), Len(arr2(i - 1, 1)))   '**********
    ...
    For i = 0 To qty - 1
        ...
        ElseIf Me.tbPart.Text = "ASR7024PF-AC" Then
            myVars.Item("Model").value = "ASR7024-AC"
        ElseIf Me.tbPart.Text = "ASR7024EPF-AC" Then
            myVars.Item("Model").value = "ASR7024E-AC"
        ElseIf Me.tbPart.Text = "ASR8048PF-AC" Then
            myVars.Item("Model").value = "ASR8048-AC"
        ElseIf Me.tbPart.Text = "ASR8048EPF-AC" Then
            myVars.Item("Model").value = "ASR8048E-AC"
        ElseIf Me.tbPart.Text = "ASR8024PF-AC" Then
            myVars.Item("Model").value = "ASR8024-AC"
        ElseIf Me.tbPart.Text = "ASR8024EPF-AC" Then
            myVars.Item("Model").value = "ASR8024E-AC"
        ElseIf Me.tbPart.Text = "ASR7048PF-AC" Then
            myVars.Item("Model").value = "ASR7048-AC"
        ElseIf Me.tbPart.Text = "ASR7048EPF-AC" Then
            myVars.Item("Model").value = "ASR7048E-AC"
        ElseIf Me.tbPart.Text = "ASR6226PF-AC" Then
            myVars.Item("Model").value = "ASR6226-AC"
        ElseIf Me.tbPart.Text = "ASR6326PF-AC" Then
        ...
        Else
            ...
            Else
                ...
                Else
                    ...
                    ElseIf (Me.tbPart.Text = "ASR7024PF-AC") Then
                        Me.tbSNFrom.Text = getNewStartSN_7("F74CA", p_version)
                    ElseIf (Me.tbPart.Text = "ASR6326PF-AC") Then
                        Me.tbSNFrom.Text = getNewStartSN_6("F63A", p_version)
                    ElseIf (Me.tbPart.Text = "ASR7024EPF-AC") Then
                        Me.tbSNFrom.Text = getNewStartSN_7("F74EA", p_version)
                    ElseIf (Me.tbPart.Text = "ASR8048PF-AC") Then
                        Me.tbSNFrom.Text = getNewStartSN_7("F88CA", p_version)
                    ElseIf (Me.tbPart.Text = "ASR8048EPF-AC") Then
                        Me.tbSNFrom.Text = getNewStartSN_7("F88EA", p_version)
                    ElseIf (Me.tbPart.Text = "ASR8024PF-AC") Then
                        Me.tbSNFrom.Text = getNewStartSN_7("F84CA", p_version)
                    ElseIf (Me.tbPart.Text = "ASR8024EPF-AC") Then
                        Me.tbSNFrom.Text = getNewStartSN_7("F84EA", p_version)
                    ElseIf (Me.tbPart.Text = "ASR7048PF-AC") Then
                        Me.tbSNFrom.Text = getNewStartSN_7("F78CA", p_version)
                    ElseIf (Me.tbPart.Text = "ASR7048EPF-AC") Then
                        Me.tbSNFrom.Text = getNewStartSN_7("F78EA", p_version)
                    ElseIf (Me.tbPart.Text = "ASR6226PF-AC") Then
                        Me.tbSNFrom.Text = getNewStartSN_6("F62A", p_version)
                   End If
               End If
           End If
        End If
