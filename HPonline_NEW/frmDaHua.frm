...
Private Sub OpenLppx()
    ...
    Set myDoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\标签模板\大华模板\" & "大华发货标签1.lab")
...
'                        MsgBox "大华资料保存失败不能打印!", vbInformation + vbOKOnly, "资料保存失败"
'                        '        txtSN.SetFocus
'                        UnloadLppx
'                        Exit Sub
'                    End If
