...
End If
 ...
 If UploadH3CInfo2(False, Trim(Me.txtSN.Text), Trim(Me.txtVer.Text), "NA", "N/A", "CHINA", golUSERNAME, PB) = False Then
...
If UploadH3C_PB(PB, Trim(UCase(txtSN.Text)), Trim(UCase(txtVer.Text)), "NA", "N/A", "CHINA", "frmNewNECPrint") = False Then
...
End If
   ...
   If chkNonTurkey.Value = 1 Then
     myObjs("Turkey RoHS(1)").Top = 100000
     End If
   ...
   myObjs("项目描述3").Top = 100000
   Else
   myVars.Item("项目描述3").Value = txtDecripe3.Text
   End If

    If txtSZ.Text <> "SZ" Then
        myObjs("SZ").Top = 100000
   End If

  '  myVars.Item("Part Number") = Mid(txtSN.Text, 3, 8)
    ...
    '=====================================================================
     ...
     sql = "SELECT [ID],[PartNum],[HardWare_Revision],[Product_Describe1],[Product_Describe2],[Product_Describe3],[EAN],[G15_Revision],[GW] " & _
      ...
      Else
        ...
        ElseIf rec.Fields(13) = "No" Or rec.Fields(13) = "N/A" Then
            chkTurkey.Value = 0
