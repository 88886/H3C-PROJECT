...
Private Sub cmdPrint_Click()
   ...
   If chkY1.Value = 0 And chkY2.Value = 0 And chkY3.Value = 0 Then
        ...
        Exit Sub
   End If
    If chkY1.Value + chkY2.Value + chkY3.Value + Me.chkN.Value > 1 Then
...
'                "or MaterialNumber like 'HUV" & txtCPN.Text & "%' ) "
            sql = "select part_revision,part_number from [10.11.1.130].afg_active_90.dbo.WORK_ORDER A ,[10.11.1.130].afg_active_90.dbo.WORK_ORDER_ITEMS B " & _
                "WHERE A.order_key = B.order_key AND A.order_number ='" & tempWO & "' and ( part_number like 'HUVC" & txtCPN.Text & "%' or part_number like 'HUV" & txtCPN.Text & "%')"
