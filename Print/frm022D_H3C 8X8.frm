VERSION 5.00
Begin VB.Form frm022D_H3C_8X8 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "H3C 单板阶二维码标签"
   ClientHeight    =   6435
   ClientLeft      =   45
   ClientTop       =   405
   ClientWidth     =   10920
   ...
   Begin VB.PictureBox picH3C 
      ...
      Height          =   5940
      Left            =   0
      Picture         =   "frm022D_H3C 8X8.frx":0000
      ScaleHeight     =   5910
      ScaleWidth      =   10875
      TabIndex        =   6
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frm022D_H3C_8X8"
...
Private Sub cmdPrint_Click()
    If chkY.Value + Me.chkY2.Value + chkY3.Value + chkY4.Value + chkN.Value + chkN3.Value + chkN4.Value <> 1 Then
...
'==================edit by ben 2011-10-14 start========================
       ...
       str4 = leftstr & Right("000000" & strFinal4, 6)
         ...
         If i + 5 > qty - 1 Then
            strFinal5 = endStr
            strFinalLength = Len(strFinal5)
       Else
            strFinal5 = CStr(CLng(rightstr) + i + 5)
            strFinalLength = Len(strFinal5)
            normalSNFlag5 = True
       End If
       
       For m = strprevisouslength To strFinalLength - 1
            strFinal5 = "0" + strFinal5
       Next
       str5 = leftstr & Right("000000" & strFinal5, 6)
       ...
       If UploadH3CInfo(Pb, Trim(str), Trim(Me.txtVer.Text), "NA", "N/A", "CHINA", golUSERNAME) = False _
            ...
            Or UploadH3CInfo(Pb, Trim(str4), Trim(Me.txtVer.Text), "NA", "N/A", "CHINA", golUSERNAME) = False _
             Or UploadH3CInfo(Pb, Trim(str5), Trim(Me.txtVer.Text), "NA", "N/A", "CHINA", golUSERNAME) = False Then
       ...
       If UploadH3C_PB(Pb, Trim(str), Trim(Me.txtVer.Text), "NA", "N/A", "CHINA", golUSERNAME) = False _
            ...
            Or UploadH3C_PB(Pb, Trim(str4), Trim(Me.txtVer.Text), "NA", "N/A", "CHINA", golUSERNAME) = False _
            Or UploadH3C_PB(Pb, Trim(str5), Trim(Me.txtVer.Text), "NA", "N/A", "CHINA", golUSERNAME) = False Then
...
'===============add by Carson 2015-12-15 start===============
        If reprint = False Then
            If Connect.isPrintedLabel(Trim(str), Me.Name) = True _
                ...
                Or Connect.isPrintedLabel(Trim(str4), Me.Name) = True _
                 Or Connect.isPrintedLabel(Trim(str5), Me.Name) = True Then
                MsgBox ("此序列号已打印！")
                txtSN.SetFocus
                UnloadLppx
                cmdCancel_Click
...
'            myVars.Item("2D3").Value = str2
  ...
  '===============add by Carson 2015-12-15 start===============
            ...
            If normalSNFlag5 = True Then
                Call Connect.addPrintedLabel(str5, Me.Name)
            End If
                ...
                Else
                    ...
                    Else
                        ...
                        ElseIf (Connect.GetPBStatusfromDB(txtCPN.Text) = "Y1") Then
                            ...
                            Me.chkN4.Value = 0
                            Me.chkN4.Enabled = False
                        ElseIf (Connect.GetPBStatusfromDB(txtCPN.Text) = "Y4") Then
                            Me.chkY4.Value = 1
                            Me.chkY4.Enabled = False
                            Me.chkY3.Value = 0
                            Me.chkY3.Enabled = False
                            ...
                            Me.chkN.Value = 0
                            Me.chkN.Enabled = False
                        ElseIf (Connect.GetPBStatusfromDB(txtCPN.Text) = "N3") Then
                            Me.chkN3.Value = 1
                            Me.chkN3.Enabled = False
                            Me.chkN.Value = 0
                            Me.chkN.Enabled = False
                            ...
                            Me.chkY4.Value = 0
                            Me.chkY4.Enabled = False
                        ElseIf (Connect.GetPBStatusfromDB(txtCPN.Text) = "N1") Then
                            Me.chkN.Value = 1
                            Me.chkN.Enabled = False
                            Me.chkN3.Value = 0
                            Me.chkN3.Enabled = False
                            ...
                            Me.chkY4.Value = 0
                            Me.chkY4.Enabled = False
                        ElseIf (Connect.GetPBStatusfromDB(txtCPN.Text) = "N4") Then
                            Me.chkN4.Value = 1
                            Me.chkN4.Enabled = False
                            Me.chkN3.Value = 0
                            Me.chkN3.Enabled = False
...
Private Sub OpenLppx()
   ...
   Set myDoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\打印中心\" & "0302二维码标签8X8.Lab")
    ...
    If (KeyAscii = 13) Then
        ...
        Else
            ...
            sql = "select part_revision,(select order_type_S from [10.11.1.130].afg_active_90.dbo.UDA_Order where object_key=A.order_key) order_type from [10.11.1.130].afg_active_90.dbo.WORK_ORDER A ,[10.11.1.130].afg_active_90.dbo.WORK_ORDER_ITEMS B " & _
                ...
                " or part_number like 'HWFC" & txtCPN.Text & "' )"
