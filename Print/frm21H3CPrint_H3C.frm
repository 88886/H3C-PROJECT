VERSION 5.00
Begin VB.Form frm21H3CPrint_H3C 
   BackColor       =   &H00FFFFFF&
   ...
   EndProperty
   Icon            =   "frm21H3CPrint_H3C.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   5160
   ScaleWidth      =   10785
   ...
   Begin VB.PictureBox picH3C 
      ...
      Height          =   1575
      Left            =   120
      Picture         =   "frm21H3CPrint_H3C.frx":13652
      ScaleHeight     =   1545
      ScaleWidth      =   10425
      TabIndex        =   6
      Top             =   480
   ...
   End
End
Attribute VB_Name = "frm21H3CPrint_H3C"
...
Private Sub cmdPrint_Click()
    ...
    If Me.chkY.Value + Me.chkY2.Value + Me.chkN.Value + Me.chkN4.Value > 1 Then
        MsgBox "环保属性未输入多个,不能打印!", vbInformation + vbOKOnly, "输入环保属性多个"
        txtSN.SetFocus
        Exit Sub
    End If
