...
Private Sub cmdPrint_Click()
   ...
   If (tbPart.Text = "ASR6026PF" Or tbPart.Text = "ASR6026PF-BB" Or tbPart.Text = "ASR6126PF" Or tbPart.Text = "ASR6126PF-BB" Or tbPart.Text = "ASR6026PF-DC" Or tbPart.Text = "ASR6126PF-DC" Or Me.tbPart.Text = "ASR7024PF-AC" Or Me.tbPart.Text = "ASR7024PF-AC" Or Me.tbPart.Text = "ASR7024EPF-AC" Or Me.tbPart.Text = "ASR8048PF-AC" Or Me.tbPart.Text = "ASR8048EPF-AC" Or Me.tbPart.Text = "ASR8024PF-AC" Or Me.tbPart.Text = "ASR8024EPF-AC" Or Me.tbPart.Text = "ASR7048PF-AC" Or Me.tbPart.Text = "ASR7048EPF-AC" Or Me.tbPart.Text = "ASR6326PF-AC" Or tbPart.Text = "ASR6226PF-AC") Then
    OpenBoxLppx
...
'    GP1326PF-AC;ASR6326-AC;MS4326-AC;735000801125
    ...
    "ASR7024PF-AC;ASR7024-AC;;7350008015852;" & _
    "ASR7024EPF-AC;ASR7024E-AC;;7350008015845;" & _
    "ASR8048PF-AC;ASR8048-AC;;7350008015975;" & _
    "ASR8048EPF-AC;ASR8048E-AC;;7350008015968;" & _
    "ASR8024PF-AC;ASR8024-AC;;7350008015937;" & _
    "ASR8024EPF-AC;ASR8024E-AC;;7350008015920;" & _
    "ASR7048PF-AC;ASR7048-AC;;7350008015890;" & _
    "ASR7048EPF-AC;ASR7048E-AC;;7350008015906;" & _
    ...
    "ASR6026PF-DC;ASR6126-DC;;735000801113;" & _
...
Private Sub tbMAC_KeyPress(KeyAscii As Integer)
    If (KeyAscii = 13) Then
        If (Len(tbMAC.Text) <> 12 And Right(tbMAC.Text, 1) <> "0" And Right(tbMAC.Text, 1) <> "2" And Right(tbMAC.Text, 1) <> "4" And Right(tbMAC.Text, 1) <> "8" And Right(tbMAC.Text, 1) <> "A" And Right(tbMAC.Text, 1) <> "C" And Right(tbMAC.Text, 1) <> "E") Then
