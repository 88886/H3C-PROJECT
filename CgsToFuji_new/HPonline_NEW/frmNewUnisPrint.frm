VERSION 5.00
Begin VB.Form frmNewUnisPrint 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "New UNIS Label Print"
   ClientHeight    =   11805
   ClientLeft      =   45
   ClientTop       =   405
   ClientWidth     =   16605
   ...
   Begin VB.Frame fmVar 
      ...
      Begin VB.PictureBox Picture13 
         Height          =   495
         Left            =   5520
         Picture         =   "frmNewUnisPrint.frx":13652
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   100
         Top             =   5040
   ...
   Begin VB.PictureBox picH3C 
      ...
      Height          =   4575
      Left            =   120
      Picture         =   "frmNewUnisPrint.frx":156D5
      ScaleHeight     =   4545
      ScaleWidth      =   12105
      TabIndex        =   18
      Top             =   360
   ...
   End
End
Attribute VB_Name = "frmNewUnisPrint"
...
If UploadH3C_PB(PB, Trim(UCase(txtSN.Text)), Trim(UCase(txtVer.Text)), "NA", "N/A", "CHINA", "frmNewUnisPrint") = False Then
...
'
      ...
      sql = "select case when Print_SV = 1 then 'Y' else 'N' end from tblUNISNew where  Part_Number ='" & Mid(txtSN.Text, 3, 8) & "'  and Part_Revision = '" & txtHV.Text & "'"
...
'             txtVer.Text = rs8.Fields(0)
      ...
      '===========================================================
       ...
       sql = "SELECT [ID],[Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],[NAL1],[NAL1_Title],[NAL2],[NAL2_Title]" & _
        ...
        ",[5000_State],[Remark],case when EAC is null then 'N/A' when EAC = 0 then 'No' when EAC = 1 then 'Yes' end as 'EAC' FROM [Print].[dbo].[tblUNISNew] where Part_Number = '" & _
...
Private Sub OpenLppx()
   ...
   Set myDoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\UNIS发货标签\" & "UNIS.lab")
