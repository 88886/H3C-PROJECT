    ...
    If (KeyAscii = 13) Then
      ...
      If Len(Replace(Trim(txtSN.Text), Chr(13) & Chr(10), "")) = 10 Then
            ...
            If rs4.EOF = True Then
                MsgBox "MES系统没有对应机种版本信息", vbOKOnly + vbExclamation, "警告"
                txtSN.Text = ""
                txtSN.SetFocus
                rs3.Close
                rs4.Close
      ...
      If Len(Replace(Trim(txtSN.Text), Chr(13) & Chr(10), "")) = 20 Then
        ...
        rs4.Open str
        If rs4.EOF = True Then
            MsgBox "MES没有对应机种版本信息", vbOKOnly + vbExclamation, "警告"
            txtSN.Text = ""
            txtSN.SetFocus
            rs.Close
            rs4.Close
      ...
      Dim spath As String
      spath = "\\10.11.1.25\Public\Manufacture\标签模板\装箱清单\" + Trim(txtModel.Text) + Trim(txtVersion.Text) + ".doc"
       'spath = "\\10.11.1.25\Public\Manufacture\标签模板\装箱清单试用\" + Trim(txtModel.Text) + "_" + Trim(txtVersion.Text) + "三合一资料.docx"
