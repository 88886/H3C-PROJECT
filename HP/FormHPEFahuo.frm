...
Begin VB.Form FormHPEFahuo 
   ...
   End
End
Attribute VB_Name = "FormHPEFahuo"
...
Private Sub OpenLppx()
    ...
    'Set myDoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\逆向标签模板\" & "新HPE发货标签NEW.lab")
    Set myDoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\逆向标签模板\" & "备件HPE发货标签模板.lab")
...
Private Sub cmdPrint_HPSN_Click()
 ...
 'add by robin for Rohs Code
'            6.  序列号中年月：2006.07~2012.07：一维条码及文本固定打印"R3"；
'            7.  序列号中年月：2012.08~2012.12：一维条码及文本固定打印"R4"；
'            8.  序列号中年月：2013.01~2015.07：一维条码及文本固定打印"R5"；
'            9.  序列号中年月：2015.08~2018.10：一维条码及文本固定打印"R6"；
'            10. 序列号中年月：2018.11~：一维条码及文本固定打印"R7"。

            
           Dim year As String
           Dim mon As String
                                 
           year = Mid(Trim(txtSN.Text), 3, 1)
           mon = HEXTODEC(Mid(Trim(txtSN.Text), 4, 1))
   ...
   'add by robin for Rohs Code end
    ...
    myVars.Item("ROHS CODE").Value = UCase(txtRohs.Text)
