VERSION 5.00
Begin VB.Form frmHP5020_Merge 
   Caption         =   "逆向-合并纯HP产品--HP SN标签50*20"
   ClientHeight    =   8340
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8895
   ...
   Begin VB.CommandButton cmdCancel_HPSN 
      ...
      Width           =   1215
   End
   Begin VB.CommandButton frmHP5020_RMA 
      Appearance      =   0  'Flat
      BackColor       =   &H80000009&
      Caption         =   "打 印"
      Enabled         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmHP5020_Merge"
...
Private Sub cmdPrint_HPSN_Click()
    ...
    If mac = "" Then
        myObjs("Text1(16) Copy(1)").Top = 10000
        myObjs("Text1 Copy(1)").Top = 10000
...
Private Sub OpenLppx()
    ...
    Set myDoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\逆向标签模板\HP本体标签逆向\" & "纯HPE SN标签5020.lab")
'    If txtDesc2.Text = "" Then
