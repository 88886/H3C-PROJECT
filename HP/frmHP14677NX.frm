...
Begin VB.Form frmHP14677NX 
   Caption         =   "逆向-纯HP产品--HP SN标签14.6*7.7"
   ClientHeight    =   7395
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   8025
...
Private Sub OpenLppx()
    ...
    Set myDoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\逆向标签模板\HP本体标签逆向\" & "HP SN标签14677-1.lab")
...
Private Sub OpenLppx2()
    Me.MousePointer = vbHourglass
    Set myDoc2 = myApp2.Documents.Open("\\sz-fs01\Public\Manufacture\逆向标签模板\HP本体标签逆向\" & "HP SN标签14677-2.lab")
    Me.MousePointer = vbDefault
