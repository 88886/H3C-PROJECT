VERSION 5.00
Begin VB.Form frmNiXiangH3CPrintWarranty 
   BackColor       =   &H00E0E0E0&
   ...
   EndProperty
   Icon            =   "frmH3CPrintWarranty_NiXiang.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   5805
   ScaleWidth      =   9705
   ...
   End
End
Attribute VB_Name = "frmNiXiangH3CPrintWarranty"
...
Private Sub cmdPrint_Click()
  ...
  Dim res2 As New ADODB.Recordset
   ...
   End If
     ...
     sql = "select TYPE from SingleUnit where SN='" & partNum & "'"
     If rec.State = 1 Then
      rec.Close
       End If
     ...
     End If
      ...
      sql = "select url_S from AT_afg_warrantyCard_Maintain where partNumber_S = 'HWF" & partNum & "'and valid_I =1"
     If res.State = 1 Then
      res.Close
       End If
...
Private Sub OpenLppx()
   ...
   Set myDoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\逆向标签模板\" & "逆向保修卡3111A00K.lab")
