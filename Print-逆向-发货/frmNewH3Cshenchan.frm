...
Begin VB.Form frmNewH3Cshenchan 
   ...
   Begin VB.Frame fmVar 
      ...
      Begin VB.ComboBox txtSZ 
         ...
         EndProperty
         Height          =   405
         ItemData        =   "frmNewH3Cshenchan.frx":13652
         Left            =   14520
         List            =   "frmNewH3Cshenchan.frx":1365C
      ...
      Begin VB.PictureBox Picture13 
         Height          =   495
         Left            =   10200
         Picture         =   "frmNewH3Cshenchan.frx":13666
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   102
         Top             =   5160
   ...
   Begin VB.PictureBox picH3C 
      ...
      Height          =   4575
      Left            =   120
      Picture         =   "frmNewH3Cshenchan.frx":156E9
      ScaleHeight     =   4545
      ScaleWidth      =   11865
      TabIndex        =   1
      Top             =   480
...
''        myVars.Item("Code").Value =
   ...
   If Trim(Me.txtNAL2.Text) <> "/" And Trim(Me.txtNAL2.Text) <> "N/A" And Trim(Me.txtNAL2Title.Text) <> "/" And Trim(Me.txtNAL2Title.Text) <> "N/A" Then
        myVars.Item("NAL2").Value = txtNAL2.Text & "(" & Me.txtNAL2Title.Text & ")"
   Else
...
'        Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\" & "H3CNEW-新生产.lab")
'   Else
'        Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\" & "分销H3CNEW-新生产.lab")
'   End If
   ...
   If rec1.EOF = False Then
        If OldFlag = True Then '旧模板
            ...
            ElseIf rec1.Fields(0) = False And rec1.Fields(1) = True Then
                Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\" & "服务器H3CNEW-新生产.lab")
            Else 'never process
        ...
        Else '新模板
            If rec1.Fields(0) = True And rec1.Fields(1) = True Then
                ...
                Set mydoc = myApp.Documents.Open("xx.lab")
            ElseIf rec1.Fields(0) = False And rec1.Fields(1) = False Then
                Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\新H3C地址模板\" & "H3CNEW-新生产.lab")
            ElseIf rec1.Fields(0) = True And rec1.Fields(1) = False Then
                Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\新H3C地址模板\" & "分销H3CNEW-新生产.lab")
            ElseIf rec1.Fields(0) = False And rec1.Fields(1) = True Then
                Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\新H3C地址模板\" & "服务器H3CNEW-新生产.lab")
            Else 'never process
                MsgBox "分销产品和服务器产品维护错误，不允许打印，请联系ME"
                Set mydoc = myApp.Documents.Open("xx.lab")
            End If
