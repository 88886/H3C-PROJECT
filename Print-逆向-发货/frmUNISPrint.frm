...
Begin VB.Form frmUNISPrint 
   ...
   Begin VB.Frame fmVar 
      ...
      Begin VB.PictureBox Picture13 
         Height          =   495
         Left            =   10200
         Picture         =   "frmUNISPrint.frx":13652
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   102
         Top             =   5280
   ...
   Begin VB.PictureBox picH3C 
      ...
      Height          =   4575
      Left            =   240
      Picture         =   "frmUNISPrint.frx":156D5
      ScaleHeight     =   4545
      ScaleWidth      =   11865
      TabIndex        =   1
      Top             =   600
   ...
   End
End
Attribute VB_Name = "frmUNISPrint"
...
'        Dim stringSQL As String
  ...
  '============add by carson end  =============
   ...
   If OldFlag = True Then '
        Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\" & "UNIS-备件.lab")
   Else
        Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\新H3C地址模板\" & "UNIS-备件.lab")
   End If
