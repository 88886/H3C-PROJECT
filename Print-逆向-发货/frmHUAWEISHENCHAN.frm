...
Private Sub cmdPrint_Click()
   ...
   End If
    ...
    If UploadH3CInfo(PB, Trim(txtSN.Text), Trim(txtVer.Text), "NA", "N/A", "CHINA", "NXFH_HWSCPrint") = False Then
        MsgBox "资料保存失败不能打印!", vbInformation + vbOKOnly, "资料保存失败"
        txtSN.SetFocus
        Exit Sub
    End If
    
    If UploadH3C_PB(PB, Trim(txtSN.Text), Trim(txtVer.Text), "NA", "N/A", "CHINA", "NXFH_HWSCPrint") = False Then
...
Private Sub OpenLppx()
   ...
   Set myDoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615\" & "HUAWEI-新逆向生产.lab")
