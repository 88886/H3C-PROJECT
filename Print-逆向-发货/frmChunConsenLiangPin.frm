VERSION 5.00
Begin VB.Form frmChunConsenLiangPin 
   Caption         =   "海康备件良品"
   ClientHeight    =   9225
   ClientLeft      =   5760
   ClientTop       =   1155
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image3 
         Height          =   6045
         Left            =   -240
         Picture         =   "frmChunConsenLiangPin.frx":0000
         Top             =   -480
         Width           =   14805
      End
   End
   ...
   End
End
Attribute VB_Name = "frmChunConsenLiangPin"
...
Private Sub OpenLppx()
    ...
    Set mydoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\新H3C地址模板\" & "海康-备件良品.lab")
