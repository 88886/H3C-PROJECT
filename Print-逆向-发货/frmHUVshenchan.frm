...
'   国内生产：\\sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615     Uniview-生产.lab
'海外生产：\\sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615    Uniview-生产-海外.lab
'上海天跃生产：\\sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615   Uniview-生产-上海天跃.lab
'Uniview20140320
'   If Me.txtSalesArea.Text = "国内" Then
'        Set mydoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615\Uniview20140420\" & "Uniview-生产-NEW.Lab")
'   ElseIf Me.txtSalesArea.Text = "海外" Then
'        Set mydoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615\Uniview20140420\" & "Uniview-生产-海外.lab")
'   ElseIf Me.txtSalesArea.Text = "上海天跃" Then
'        Set mydoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615\Uniview20140420\" & "Uniview-生产-上海天跃.lab")
'   Else
'      MsgBox "没有销售区域,不能打印!", vbInformation + vbOKOnly, "销售区域不能为空"
'      Exit Sub
'      Unload Me
'   End If
   ...
   'Set mydoc = myApp.Documents.Open("\\Sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615\" & "Uniview-生产.lab")
   'Set myDoc = myApp.Documents.Open("G:\flash\标签模板\" & "H3C.lab")
   
    If Me.txtSalesArea.Text = "中英文" Then
        Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615\Uniview20140606\" & "Uniview-生产-中英文.lab")
    ElseIf Me.txtSalesArea.Text = "纯英文" Then
        Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615\Uniview20140606\" & "Uniview-生产-纯英文.lab")
    ElseIf Me.txtSalesArea.Text = "讯美" Then
        Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\逆向标签模板\逆向20120615\Uniview20140606\" & "Uniview-生产-讯美.lab")
    Else
      MsgBox "没有标签类型,不能打印!", vbInformation + vbOKOnly, "销售区域不能为空"
      Exit Sub
      Unload Me
    End If
