VERSION 5.00
Begin VB.Form frmUNIS_LiangPin 
   BackColor       =   &H00FFFFFF&
   ...
   Begin VB.Frame fmVar 
      ...
      Begin VB.PictureBox Picture13 
         Height          =   495
         Left            =   10200
         Picture         =   "frmUNIS_LiangPin.frx":0000
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   104
         Top             =   5160
   ...
   Begin VB.PictureBox picH3C 
      ...
      Height          =   4575
      Left            =   0
      Picture         =   "frmUNIS_LiangPin.frx":2083
      ScaleHeight     =   4545
      ScaleWidth      =   13905
      TabIndex        =   3
      Top             =   480
   ...
   End
End
Attribute VB_Name = "frmUNIS_LiangPin"
...
'        Dim stringSQL As String
  ...
  '============add by carson end  =============
   ...
   If OldFlag = True Then '旧模板
        Set myDoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\" & "UNIS-备件良品.lab")
   Else '新模板
        Set myDoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\新H3C地址模板\" & "UNIS-备件良品.lab")
   End If
