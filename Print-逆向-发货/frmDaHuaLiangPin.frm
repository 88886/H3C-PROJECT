VERSION 5.00
Begin VB.Form frmDaHuaLiangPin 
   Caption         =   "大华备件良品"
   ClientHeight    =   10935
   ClientLeft      =   3975
   ClientTop       =   390
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image3 
         Height          =   5385
         Left            =   0
         Picture         =   "frmDaHuaLiangPin.frx":0000
         Top             =   -120
         Width           =   13365
      End
   End
   ...
   End
End
Attribute VB_Name = "frmDaHuaLiangPin"
...
Private Sub OpenLppx()
    ...
    Set mydoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\H3C发货标签NEW\逆向H3CNEW\新H3C地址模板\" & "大华-逆向备件良品.lab")
