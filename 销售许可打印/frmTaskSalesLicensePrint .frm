VERSION 5.00
Begin VB.Form frmSalesLicense_TASK 
   BackColor       =   &H00E0E0E0&
   ...
   EndProperty
   Icon            =   "frmTaskSalesLicensePrint .frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   5805
   ScaleWidth      =   9705
   ...
   End
End
Attribute VB_Name = "frmSalesLicense_TASK"
...
Private Sub cmdPrint_Click()
  ...
  Dim res2 As New ADODB.Recordset
   ...
   sql = "select salesPN_S from AT_afg_salesLicense_Maintain where partNumber_S = '" & Mid(SN, 3, 8) & "'and valid_I =1"
     If res.State = 1 Then
      res.Close
       End If
...
Private Sub OpenLppx()
   ...
   Set myDoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\标签模板\销售许可打印模板\" & salesPN & "销售许可证标签模板.lab")
