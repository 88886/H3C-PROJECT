...
Private Sub Form_Load()
  ...
  DisplayVerInfo
  'show the results'  frmLogin.Caption = Filename + " ( Version: " & FileVer & " )"
...
Private Sub check_ver()
    'strSql = "select APP_Version from Version_Control with(NOLOCK) where APP_Name=N'XXXX' "
