...
Begin VB.Form frmSRIESetting 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "SRIE Setting"
   ClientHeight    =   11220
   ClientLeft      =   45
   ClientTop       =   405
   ClientWidth     =   17535
   ...
   Begin VB.Frame fmH3C 
      ...
      Begin VB.PictureBox Picture13 
         Height          =   495
         Left            =   13560
         Picture         =   "frmSRIESetting.frx":0000
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   98
         Top             =   5760
      ...
      Begin VB.PictureBox Picture1 
         Height          =   495
         Left            =   120
         Picture         =   "frmSRIESetting.frx":2083
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   48
         Top             =   2760
      ...
      Begin VB.PictureBox Picture2 
         Height          =   615
         Left            =   13440
         Picture         =   "frmSRIESetting.frx":2B31
         ScaleHeight     =   555
         ScaleWidth      =   675
         TabIndex        =   41
         Top             =   3480
      ...
      Begin VB.PictureBox Picture3 
         Height          =   615
         Left            =   13560
         Picture         =   "frmSRIESetting.frx":4097
         ScaleHeight     =   555
         ScaleWidth      =   555
         TabIndex        =   40
         Top             =   5040
      ...
      Begin VB.PictureBox Picture4 
         Height          =   735
         Left            =   10560
         Picture         =   "frmSRIESetting.frx":5A29
         ScaleHeight     =   675
         ScaleWidth      =   3555
         TabIndex        =   39
         Top             =   2640
      ...
      Begin VB.PictureBox Picture5 
         Height          =   495
         Left            =   12840
         Picture         =   "frmSRIESetting.frx":D6B7
         ScaleHeight     =   435
         ScaleWidth      =   1395
         TabIndex        =   38
         Top             =   4320
      ...
      Begin VB.PictureBox Picture7 
         Height          =   495
         Left            =   120
         Picture         =   "frmSRIESetting.frx":FA55
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   37
         Top             =   3720
      ...
      Begin VB.PictureBox Picture8 
         Height          =   495
         Left            =   120
         Picture         =   "frmSRIESetting.frx":107AB
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   36
         Top             =   4440
      ...
      Begin VB.PictureBox Picture9 
         Height          =   615
         Left            =   120
         Picture         =   "frmSRIESetting.frx":11075
         ScaleHeight     =   555
         ScaleWidth      =   555
         TabIndex        =   35
         Top             =   5160
      ...
      Begin VB.PictureBox Picture10 
         Height          =   495
         Left            =   6480
         Picture         =   "frmSRIESetting.frx":122D7
         ScaleHeight     =   435
         ScaleWidth      =   555
         TabIndex        =   34
         Top             =   3720
      ...
      Begin VB.PictureBox Picture11 
         Height          =   495
         Left            =   6480
         Picture         =   "frmSRIESetting.frx":12E7D
         ScaleHeight     =   435
         ScaleWidth      =   555
         TabIndex        =   33
         Top             =   4440
      ...
      Begin VB.PictureBox Picture12 
         Height          =   615
         Left            =   6600
         Picture         =   "frmSRIESetting.frx":13BDF
         ScaleHeight     =   555
         ScaleWidth      =   435
         TabIndex        =   32
         Top             =   5160
      ...
      Begin VB.PictureBox Picture6 
         Height          =   615
         Left            =   5520
         Picture         =   "frmSRIESetting.frx":14845
         ScaleHeight     =   555
         ScaleWidth      =   555
         TabIndex        =   24
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "frmSRIESetting"
...
Private Sub cmdConfirm_Click()
   ...
   If txtProductID.Text = "" Then
      MsgBox "产品代码不能为空!", vbExclamation + vbOKOnly, "产品代码空"
   ...
   Dim CE, WEEE, ChinaRoHS, RoHS, TurkeyRoHS, SVPrint, ATick, CTick, ICT, RCM, Gost, KC, ATick_ID, CTick_ID, ICT_ID, RCM_ID, Gost_ID, KC_ID, PWPrint, EAC As String
...
'    FTStatus = CStr(cb5000.ListIndex)
  ...
  txtGW.Text = LCase(Trim(txtGW.Text))
   ...
   If op = "Insert" Then
      ...
      sql = "select Count(*) from tblSRIE where Part_Number ='" & Trim(txtSN.Text) & "' and Part_Revision ='" & Trim(txtHV.Text) & "' "
      ...
      sql = "insert [tblSRIE]([Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],[NAL1],[NAL1_Title],[NAL2],[NAL2_Title],[CE],[WEEE],[ChinaRoHS],[RoHS],[TurkeyRoHS],[Ukraine],[Ukraine_ID],[ATick],[ATick_ID],[CTick],[CTick_ID],[ICT],[ICT_ID],[RCM],[RCM_ID],[Gost],[Gost_ID],[KC],[KC_ID],[Print_SV],[Print_Power],[5000_State],[Remark],EAC) " & _
            "Values('" & Trim(txtSN.Text) & "','" & Trim(txtHV.Text) & "','" & Trim(txtProductID.Text) & "','" & Trim(txtCPN.Text) & "','" & Trim(txtEPN.Text) & "','" & Trim(txtProductID.Text) & "','" & Trim(txtSize.Text) & "','" & Trim(txtGW.Text) & "','" & Trim(txtMS.Text) & _
             ...
             ",'" & Gost_ID & "'," & KC & ",'" & KC_ID & "'," & SVPrint & "," & PWPrint & ",'" & ftStatus & "','" & txtRemark.Text & "'," & EAC & ")"
             
      sql = sql & " insert tblSRIE_log(CREATE_USER,[Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],[NAL1],[NAL1_Title],[NAL2],[NAL2_Title],[CE],[WEEE],[ChinaRoHS],[RoHS],[TurkeyRoHS],[Ukraine],[Ukraine_ID],[ATick],[ATick_ID],[CTick],[CTick_ID],[ICT],[ICT_ID],[RCM],[RCM_ID],[Gost],[Gost_ID],[KC],[KC_ID],[Print_SV],[Print_Power],[5000_State],[Remark],COMMENT,EAC) " & _
            "Values('" & golUSERNAME & "','" & Trim(txtSN.Text) & "','" & Trim(txtHV.Text) & "','" & Trim(txtProductID.Text) & "','" & Trim(txtCPN.Text) & "','" & Trim(txtEPN.Text) & "','" & Trim(txtProductID.Text) & "','" & Trim(txtSize.Text) & "','" & Trim(txtGW.Text) & "','" & Trim(txtMS.Text) & _
             "','" & NAL1 & "','" & NAL1Title & "','" & NAL2 & "','" & NAL2Title & "'," & CE & "," & WEEE & "," & ChinaRoHS & "," & RoHS & "," & TurkeyRoHS & "," & Ukraine & ",'" & Ukraine_ID & "'," & ATick & ",'" & ATick_ID & "'," & CTick & ",'" & CTick_ID & "'," & ICT & ",'" & ICT_ID & "'," & RCM & ",'" & RCM_ID & "'," & Gost & _
             ",'" & Gost_ID & "'," & KC & ",'" & KC_ID & "'," & SVPrint & "," & PWPrint & ",'" & ftStatus & "','" & txtRemark.Text & "','Insert'," & EAC & ")"
             
      status = Connect.excuteUpdate(sql)
      If status <> "" Then
         MsgBox "新增UNIS设定资料失败!" & "原因是" & status, vbExclamation + vbOKOnly, "新增失败"
      Else
        MsgBox "新增UNIS设定资料成功!", vbInformation + vbOKOnly, "新增成功"
      End If
      renovate ("")
      cmdInsert_Click
   ElseIf op = "Update" Then
      sql = "Update tblSRIE set CPN='" & Trim(txtCPN.Text) & "',EPN='" & Trim(txtEPN.Text) & "',ProductID ='" & Trim(txtProductID.Text) & "',Size='" & Trim(txtSize.Text) & "',GW='" & Trim(txtGW.Text) & "',CE=" & CE & ",WEEE=" & WEEE & ",ChinaRoHS=" & ChinaRoHS & ",RoHS=" & RoHS & ",TurkeyRohs=" & TurkeyRoHS & "," & _
            ...
            ",RCM_ID = '" & RCM_ID & "',Gost = " & Gost & ",Gost_ID = '" & Gost_ID & "',KC = " & KC & ",KC_ID = '" & KC_ID & "',Print_Power = " & PWPrint & ",Part_Revision ='" & txtHV.Text & "',Print_SV='" & SVPrint & "',[5000_State] = '" & ftStatus & "',Remark='" & txtRemark.Text & "',EAC=" & EAC & _
      ...
      sql = sql & " insert tblSRIE_log(CREATE_USER,[Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],[NAL1],[NAL1_Title],[NAL2],[NAL2_Title],[CE],[WEEE],[ChinaRoHS],[RoHS],[TurkeyRoHS],[Ukraine],[Ukraine_ID],[ATick],[ATick_ID],[CTick],[CTick_ID],[ICT],[ICT_ID],[RCM],[RCM_ID],[Gost],[Gost_ID],[KC],[KC_ID],[Print_SV],[Print_Power],[5000_State],[Remark],COMMENT,EAC) " & _
            "Values('" & golUSERNAME & "','" & Trim(txtSN.Text) & "','" & Trim(txtHV.Text) & "','" & Trim(txtProductID.Text) & "','" & Trim(txtCPN.Text) & "','" & Trim(txtEPN.Text) & "','" & Trim(txtProductID.Text) & "','" & Trim(txtSize.Text) & "','" & Trim(txtGW.Text) & "','" & Trim(txtMS.Text) & _
             "','" & NAL1 & "','" & NAL1Title & "','" & NAL2 & "','" & NAL2Title & "'," & CE & "," & WEEE & "," & ChinaRoHS & "," & RoHS & "," & TurkeyRoHS & "," & Ukraine & ",'" & Ukraine_ID & "'," & ATick & ",'" & ATick_ID & "'," & CTick & ",'" & CTick_ID & "'," & ICT & ",'" & ICT_ID & "'," & RCM & ",'" & RCM_ID & "'," & Gost & _
             ",'" & Gost_ID & "'," & KC & ",'" & KC_ID & "'," & SVPrint & "," & PWPrint & ",'" & ftStatus & "','" & txtRemark.Text & "','Update'," & EAC & ")"
      status = Connect.excuteUpdate(sql)
      If status <> "" Then
         MsgBox "修改UNIS设定资料失败!" & "原因是" & status, vbExclamation + vbOKOnly, "修改失败"
      Else
         MsgBox "修改UNIS设定资料成功!", vbInformation + vbOKOnly, "修改成功"
      End If
      renovate ("")
      cmdCancel_Click
   End If
...
Private Sub cmdDelete_Click()
   ...
   sql = "insert tblSRIE_log(CREATE_USER,[Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],[NAL1],[NAL1_Title],[NAL2],[NAL2_Title],[CE],[WEEE],[ChinaRoHS],[RoHS],[TurkeyRoHS],[Ukraine],[Ukraine_ID],[ATick],[ATick_ID],[CTick],[CTick_ID],[ICT],[ICT_ID],[RCM],[RCM_ID],[Gost],[Gost_ID],[KC],[KC_ID],[Print_SV],[Print_Power],[5000_State],[Remark],COMMENT,EAC) " & _
             " select '" & golUSERNAME & "',[Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],[NAL1],[NAL1_Title],[NAL2],[NAL2_Title],[CE],[WEEE],[ChinaRoHS],[RoHS],[TurkeyRoHS],[Ukraine],[Ukraine_ID],[ATick],[ATick_ID],[CTick],[CTick_ID],[ICT],[ICT_ID],[RCM],[RCM_ID],[Gost],[Gost_ID],[KC],[KC_ID],[Print_SV],[Print_Power],[5000_State],[Remark],'Delete',EAC from tblSRIE " & _
             " where ID=" & mfgH3C.TextMatrix(mfgH3C.RowSel, 1) & " and Part_Number ='" & mfgH3C.TextMatrix(mfgH3C.RowSel, 2) & "'"

   sql = sql & " delete from tblSRIE where ID=" & mfgH3C.TextMatrix(mfgH3C.RowSel, 1) & " and Part_Number ='" & mfgH3C.TextMatrix(mfgH3C.RowSel, 2) & "'"
   status = Connect.excuteUpdate(sql)
   If status <> "" Then
      MsgBox "删除UNIS设定资料失败!" & "原因是" & status, vbExclamation + vbOKOnly, "删除失败"
   End If
   MsgBox "删除UNIS设定资料成功!", vbInformation + vbOKOnly, "删除成功"
   renovate ("")
End Sub
           ...
           If K = 3 Then
            ...
            If K = 19 Then
               If action = vbRetry Then
                   ...
                   status = Connect.excuteUpdate(sql)
                   If status <> "" Then
                     MsgBox "修改SRIE设定资料失败!" & "原因是" & status, vbExclamation + vbOKOnly, "修改失败"
                   End If
'                   MsgBox "修改SRIE设定资料成功!"
               ElseIf isexist = False Then
                   ...
                   status = Connect.excuteUpdate(sql)
                   If status <> "" Then
                      MsgBox "新增SRIE设定资料失败!" & "原因是" & status, vbExclamation + vbOKOnly, "修改失败"
                   End If
'                   MsgBox "新增SRIE设定资料成功!"
               End If
           End If
    ...
    If rec.State = 1 Then
     ...
     End If
       ...
       sql = "SELECT [ID],[Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],[NAL1],[NAL1_Title],[NAL2],[NAL2_Title]" & _
        ...
        " FROM [Print].[dbo].[tblSRIE] where 1 = 1"
...
'        ",[5000_State],[Remark] FROM [Print].[dbo].[tblSRIE] where 1 = 1"
     If txtSN.Text <> "" Then
...
Private Sub renovate(sql As String)
    ...
    If sql = "" Then
        ...
        ",case when Print_Power is null then 'N/A' when Print_Power = 0 then 'No' when Print_Power = 1 then 'Yes' end as 'Print_Power',[5000_State],[Remark] " & _
        ",case when EAC is null then 'N/A' when EAC = 0 then 'No' when EAC = 1 then 'Yes' end as 'EAC'" & _
        " FROM [Print].[dbo].[tblSRIE] order by Part_Number,Part_Revision"
...
'      ,[Remark]
      ...
      .TextMatrix(0, 34) = "打印版本"
      .TextMatrix(0, 35) = "打印电源"
      .TextMatrix(0, 36) = "5000状态"
      .TextMatrix(0, 37) = "备注"
      .TextMatrix(0, 38) = "EAC"
    End With
    rec.Close
...
'    [hank](ID,[Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],
'10
