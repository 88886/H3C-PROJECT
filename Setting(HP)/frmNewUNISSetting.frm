...
Begin VB.Form frmNewUNISSetting 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "New UNIS Setting"
   ClientHeight    =   11115
   ClientLeft      =   45
   ClientTop       =   405
   ClientWidth     =   17325
   ...
   Begin VB.Frame fmH3C 
      ...
      Begin VB.PictureBox Picture13 
         Height          =   495
         Left            =   13560
         Picture         =   "frmNewUNISSetting.frx":0000
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   97
         Top             =   5880
      ...
      Begin VB.PictureBox Picture1 
         Height          =   495
         Left            =   120
         Picture         =   "frmNewUNISSetting.frx":2083
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   49
         Top             =   2760
      ...
      Begin VB.PictureBox Picture2 
         Height          =   615
         Left            =   13440
         Picture         =   "frmNewUNISSetting.frx":2B31
         ScaleHeight     =   555
         ScaleWidth      =   675
         TabIndex        =   42
         Top             =   3480
      ...
      Begin VB.PictureBox Picture3 
         Height          =   615
         Left            =   13560
         Picture         =   "frmNewUNISSetting.frx":4097
         ScaleHeight     =   555
         ScaleWidth      =   555
         TabIndex        =   41
         Top             =   5040
      ...
      Begin VB.PictureBox Picture4 
         Height          =   735
         Left            =   10560
         Picture         =   "frmNewUNISSetting.frx":5A29
         ScaleHeight     =   675
         ScaleWidth      =   3555
         TabIndex        =   40
         Top             =   2640
      ...
      Begin VB.PictureBox Picture5 
         Height          =   495
         Left            =   12840
         Picture         =   "frmNewUNISSetting.frx":D6B7
         ScaleHeight     =   435
         ScaleWidth      =   1395
         TabIndex        =   39
         Top             =   4320
      ...
      Begin VB.PictureBox Picture7 
         Height          =   495
         Left            =   120
         Picture         =   "frmNewUNISSetting.frx":FA55
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   38
         Top             =   3720
      ...
      Begin VB.PictureBox Picture8 
         Height          =   495
         Left            =   120
         Picture         =   "frmNewUNISSetting.frx":107AB
         ScaleHeight     =   435
         ScaleWidth      =   435
         TabIndex        =   37
         Top             =   4440
      ...
      Begin VB.PictureBox Picture9 
         Height          =   615
         Left            =   120
         Picture         =   "frmNewUNISSetting.frx":11075
         ScaleHeight     =   555
         ScaleWidth      =   555
         TabIndex        =   36
         Top             =   5160
      ...
      Begin VB.PictureBox Picture10 
         Height          =   495
         Left            =   6480
         Picture         =   "frmNewUNISSetting.frx":122D7
         ScaleHeight     =   435
         ScaleWidth      =   555
         TabIndex        =   35
         Top             =   3720
      ...
      Begin VB.PictureBox Picture11 
         Height          =   495
         Left            =   6480
         Picture         =   "frmNewUNISSetting.frx":12E7D
         ScaleHeight     =   435
         ScaleWidth      =   555
         TabIndex        =   34
         Top             =   4440
      ...
      Begin VB.PictureBox Picture12 
         Height          =   615
         Left            =   6600
         Picture         =   "frmNewUNISSetting.frx":13BDF
         ScaleHeight     =   555
         ScaleWidth      =   435
         TabIndex        =   33
         Top             =   5160
      ...
      Begin VB.PictureBox Picture6 
         Height          =   615
         Left            =   5520
         Picture         =   "frmNewUNISSetting.frx":14845
         ScaleHeight     =   555
         ScaleWidth      =   555
         TabIndex        =   25
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "frmNewUNISSetting"
...
'    FTStatus = CStr(cb5000.ListIndex)
  ...
  txtGW.Text = LCase(Trim(txtGW.Text))
   ...
   If op = "Insert" Then
      ...
      sql = "select Count(*) from tblUNISNew where Part_Number ='" & Trim(txtSN.Text) & "' and Part_Revision ='" & Trim(txtHV.Text) & "' "
      ...
      sql = "insert [tblUNISNew]([Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],[NAL1],[NAL1_Title],[NAL2],[NAL2_Title],[CE],[WEEE],[ChinaRoHS],[RoHS],[TurkeyRoHS],[Ukraine],[Ukraine_ID],[ATick],[ATick_ID],[CTick],[CTick_ID],[ICT],[ICT_ID],[RCM],[RCM_ID],[Gost],[Gost_ID],[KC],[KC_ID],[Print_SV],[Print_Power],[5000_State],[Remark],EAC) " & _
      ...
      sql = sql & " insert tblUNISNew_log(CREATE_USER,[Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],[NAL1],[NAL1_Title],[NAL2],[NAL2_Title],[CE],[WEEE],[ChinaRoHS],[RoHS],[TurkeyRoHS],[Ukraine],[Ukraine_ID],[ATick],[ATick_ID],[CTick],[CTick_ID],[ICT],[ICT_ID],[RCM],[RCM_ID],[Gost],[Gost_ID],[KC],[KC_ID],[Print_SV],[Print_Power],[5000_State],[Remark],COMMENT,EAC) " & _
      ...
      cmdInsert_Click
   ElseIf op = "Update" Then
      sql = "Update tblUNISNew set CPN='" & Trim(txtCPN.Text) & "',EPN='" & Trim(txtEPN.Text) & "',ProductID ='" & Trim(txtProductID.Text) & "',Size='" & Trim(txtSize.Text) & "',GW='" & Trim(txtGW.Text) & "',CE=" & CE & ",WEEE=" & WEEE & ",ChinaRoHS=" & ChinaRoHS & ",RoHS=" & RoHS & ",TurkeyRohs=" & TurkeyRoHS & "," & _
    ...
    If rec.State = 1 Then
     ...
     End If
       sql = "SELECT [ID],[Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],[NAL1],[NAL1_Title],[NAL2],[NAL2_Title]" & _
        ...
        " FROM [Print].[dbo].[tblUNISNew] where 1 = 1"
...
'        ",case when Print_SV is null then 'N/A' when Print_SV = 0 then 'No' when Print_SV = 1 then 'Yes' end as 'Print_SV'" & _
'        ",case when Print_Power is null then 'N/A' when Print_Power = 0 then 'No' when Print_Power = 1 then 'Yes' end as 'Print_Power'" & _
'        ",[5000_State],[Remark] FROM [Print].[dbo].[tblUNISNew] where 1 = 1"
     If txtSN.Text <> "" Then
...
Private Sub renovate(sql As String)
    ...
    If sql = "" Then
        ...
        ",[5000_State],[Remark] " & _
        ",case when EAC is null then 'N/A' when EAC = 0 then 'No' when EAC = 1 then 'Yes' end as 'EAC'" & _
        " FROM [Print].[dbo].[tblUNISNew] order by Part_Number,Part_Revision"
    End If
    If rec.State = 1 Then
    rec.Close
    End If
...
'    [tblUNISNew](ID,[Part_Number],[Part_Revision],[ProductID],[CPN],[EPN],[Des],[Size],[GW],[MS],
'10
...
'     chkTurkeyRohs.Value = 0
    ...
    If UCase(Trim(mfgH3C.TextMatrix(mfgH3C.RowSel, 38))) = "YES" Then
        chkEAC.Value = 1
    ElseIf UCase(mfgH3C.TextMatrix(mfgH3C.RowSel, 38)) = "N/A" Or UCase(mfgH3C.TextMatrix(mfgH3C.RowSel, 38)) = "NO" Then
        chkNonEAC.Value = 1
    End If
   End If
End Sub
