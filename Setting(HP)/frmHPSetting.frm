...
Begin VB.Form frmHPSetting 
   ...
   Begin VB.Frame fmH3C 
      ...
      Top             =   0
      Width           =   12015
      Begin VB.ComboBox cbNewLabel 
         Height          =   465
         ItemData        =   "frmHPSetting.frx":2E1A
         Left            =   2280
         List            =   "frmHPSetting.frx":2E24
         TabIndex        =   47
         Top             =   4680
         Width           =   975
      End
      ...
      Begin VB.ComboBox cb5000 
         Height          =   465
         ItemData        =   "frmHPSetting.frx":2E2E
         Left            =   9120
         List            =   "frmHPSetting.frx":2E3E
         TabIndex        =   42
         Top             =   4080
         Width           =   2175
      End
...
Private Sub cmdConfirm_Click()
   ...
   If chkYes.Value + chkNo.Value = 2 Or chkYes.Value + chkNo.Value = 0 Then
      MsgBox "请选择是否上传电源代码!", vbExclamation + vbOKOnly, "是否上传电源代码未选择！"
      Exit Sub
   End If
...
'    Y，N，NA,TBD
    ...
    If Me.cbNewLabel.ListIndex = 0 Then
        new_label = "Y"
    Else
        new_label = "N"
    End If
...
'      rcd2.Close
      ...
      sql = "insert hp(h3c_bom_code,h3c_sn_iii,hp_pn,hp_product,hp_sn_iii,hp_desc1,hp_desc2,hp_gtin,hp_gtin_number,h3c_type,pack_label,hpsnproduct,[5000_status],upload_power_code,new_label)" & _
            "Values('" & txtCode.Text & "','" & txtH3CSNIII.Text & "','" & txtHPPN.Text & "','" & txtHPP.Text & "','" & txtHPSNIII.Text & "'," & _
            "'" & txtHPdesc1.Text & "','" & txtHPdesc2.Text & "','" & txtHPGtin.Text & "','" & Trim(txtHPGtinNum.Text) & "','" & txtH3CType.Text & "','" & txtPack.Text & "','" & txtHPSNProduct.Text & "','" & ftStatus & "'," & uploadPC & ",'" & new_label & "')"
      
      sql = sql & " Insert into hp_log( create_user,h3c_bom_code,h3c_sn_iii,hp_pn,hp_product,hp_sn_iii,hp_desc1,hp_desc2,hp_gtin,hp_gtin_number,h3c_type,pack_label,hpsnproduct,[5000_status],upload_power_code,new_label,comment) values " & _
            " ('" & golUSERNAME & "','" & txtCode.Text & "','" & txtH3CSNIII.Text & "','" & txtHPPN.Text & "','" & txtHPP.Text & "','" & txtHPSNIII.Text & "'," & _
            "'" & txtHPdesc1.Text & "','" & txtHPdesc2.Text & "','" & txtHPGtin.Text & "','" & Trim(txtHPGtinNum.Text) & "','" & txtH3CType.Text & "','" & txtPack.Text & "','" & txtHPSNProduct.Text & "','" & ftStatus & "'," & uploadPC & ",'" & new_label & "','Insert')"
   ...
   ElseIf op = "Update" Then
      ...
      sql = "Update hp set h3c_sn_iii='" & txtH3CSNIII.Text & "',hp_product='" & txtHPP.Text & "',[5000_status] = '" & ftStatus & "',upload_power_code = " & uploadPC & "," & _
            "hp_pn='" & txtHPPN.Text & "', hp_desc1='" & txtHPdesc1.Text & "',hp_desc2='" & txtHPdesc2.Text & "',hp_gtin='" & txtHPGtin.Text & "',hp_gtin_number='" & Trim(txtHPGtinNum.Text) & "',h3c_type='" & txtH3CType.Text & "',pack_label='" & txtPack.Text & "',hpsnproduct='" & Trim(txtHPSNProduct.Text) & "',new_label='" & Trim(new_label) & "',hp_sn_iii='" & txtHPSNIII.Text & "'" & _
            " where  h3c_bom_code='" & txtCode.Text & "' "
      
     sql = sql & " Insert into hp_log( create_user,h3c_bom_code,h3c_sn_iii,hp_pn,hp_product,hp_sn_iii,hp_desc1,hp_desc2,hp_gtin,hp_gtin_number,h3c_type,pack_label,hpsnproduct,[5000_status],upload_power_code,new_label,comment) values " & _
            " ('" & golUSERNAME & "','" & txtCode.Text & "','" & txtH3CSNIII.Text & "','" & txtHPPN.Text & "','" & txtHPP.Text & "','" & txtHPSNIII.Text & "'," & _
            "'" & txtHPdesc1.Text & "','" & txtHPdesc2.Text & "','" & txtHPGtin.Text & "','" & Trim(txtHPGtinNum.Text) & "','" & txtH3CType.Text & "','" & txtPack.Text & "','" & txtHPSNProduct.Text & "','" & ftStatus & "'," & uploadPC & ",'" & new_label & "','Update')"
...
Private Sub cmdDelete_Click()
   If mfgHP.RowSel <= 0 Then
      ...
      Exit Sub
   End If
   If MsgBox("确认要删除当前选中的数据吗？", vbYesNo, "数据删除确认") = vbYes Then
    'sql = "delete from hp where hp_pn='" & mfgHP.TextMatrix(mfgHP.RowSel, 4) & "'"
    sql = " Insert into hp_log( create_user,h3c_bom_code,h3c_sn_iii,hp_pn,hp_product,hp_sn_iii,hp_desc1,hp_desc2,hp_gtin,hp_gtin_number,h3c_type,pack_label,hpsnproduct,[5000_status],upload_power_code,new_label,comment)  " & _
                " select '" & golUSERNAME & "',h3c_bom_code,h3c_sn_iii,hp_pn,hp_product,hp_sn_iii,hp_desc1,hp_desc2,hp_gtin,hp_gtin_number,h3c_type,pack_label,hpsnproduct,[5000_status],upload_power_code,new_label,'Delete' " & _
                " from hp where hp_sn_iii='" & mfgHP.TextMatrix(mfgHP.RowSel, 6) & "' and h3c_bom_code='" & mfgHP.TextMatrix(mfgHP.RowSel, 2) & "'"
    
    sql = sql & " delete from hp where hp_sn_iii='" & mfgHP.TextMatrix(mfgHP.RowSel, 6) & "' and h3c_bom_code='" & mfgHP.TextMatrix(mfgHP.RowSel, 2) & "'"
    status = Connect.excuteUpdate(sql)
    If status <> "" Then
...
Private Sub mfgHP_Click()
    If mfgHP.RowSel > 0 Then
        ...
        If Trim(mfgHP.TextMatrix(mfgHP.RowSel, 16)) = "Y" Then
            cbNewLabel.ListIndex = 0
        Else
            cbNewLabel.ListIndex = 1
        End If
    End If
