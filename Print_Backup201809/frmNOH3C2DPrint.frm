VERSION 5.00
Begin VB.Form frmNOH3C2DPrint 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "H3C0212二维码标签"
   ClientHeight    =   6090
   ClientLeft      =   45
   ClientTop       =   405
   ClientWidth     =   10665
   ...
   Begin VB.PictureBox picH3C 
      ...
      Height          =   5940
      Left            =   0
      Picture         =   "frmNOH3C2DPrint.frx":13652
      ScaleHeight     =   5910
      ScaleWidth      =   10635
      TabIndex        =   6
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmNOH3C2DPrint"
...
'==================edit by ben 2011-10-14 start========================
    ...
    If UploadH3CInfo(Pb, Trim(UCase(str)), Trim(UCase(txtVer.Text)), "NA", "N/A", "CHINA", "单板+3COMPrint(正向)New") = False _
        Or UploadH3CInfo(Pb, Trim(UCase(str1)), Trim(UCase(txtVer.Text)), "NA", "N/A", "CHINA", "单板+3COMPrint(正向)New") = False _
        Or UploadH3CInfo(Pb, Trim(UCase(str2)), Trim(UCase(txtVer.Text)), "NA", "N/A", "CHINA", "单板+3COMPrint(正向)New") = False Then
    ...
    If UploadH3C_PB(Pb, Trim(str), Trim(Me.txtVer.Text), "NA", "N/A", "CHINA", "单板+3COMPrint(正向)New.exe") = False _
        Or UploadH3C_PB(Pb, Trim(str1), Trim(Me.txtVer.Text), "NA", "N/A", "CHINA", "单板+3COMPrint(正向)New.exe") = False _
        Or UploadH3C_PB(Pb, Trim(str2), Trim(Me.txtVer.Text), "NA", "N/A", "CHINA", "单板+3COMPrint(正向)New.exe") = False Then
...
'   If HK_Part_Flag = False Then
        ...
        Set myDoc = myApp.Documents.Open("\\sz-fs01\Public\Manufacture\打印中心\" & "风扇0212二维码标签new.Lab") 'add by carson 20171110
'   Else
...
'                txtXH.Text = ""
            ...
            Else
                ...
                Else
                    ...
                    Exit Sub
                End If
                Pb = Connect.getPbByPartList_1(tempWO, first)
